...
int _start(void)
{
    ...
    *(unsigned int *)0x62000018 = (unsigned int)Fiq;
    ...
    #define   CLK_DIV_FSYS2     *(U32 *)0x1003C548
    #define   CLK_DIV_FSYS3     *(U32 *)0x1003C54C

    printf("MMC2_RATIO:%d  MMC2_PRE_RATIO:%d  \n" ,  //50M   SDMMC
    CLK_DIV_FSYS2&0xF , (CLK_DIV_FSYS2>>8)&0xFF);

    printf("MMC4_RATIO:%d  MMC4_PRE_RATIO:%d  \n" ,  //400M  EMMC
    CLK_DIV_FSYS3&0xF , (CLK_DIV_FSYS3>>8)&0xFF);
