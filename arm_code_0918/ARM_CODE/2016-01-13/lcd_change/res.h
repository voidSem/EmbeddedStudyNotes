...
void Read_I2C_Data(unsigned int SlaveAddr , char *buffer , int len);
int clear_i2c_irq(void);
int Wait_for_irq(void);
void I2C_Init_TouchScreen(void);
...
#define   WTCON 	 *(U32 *)(wdtbase + 0x0000)
#define   WTDAT 	 *(U32 *)(wdtbase + 0x0004)
#define   WTCNT 	 *(U32 *)(wdtbase + 0x0008)
#define   WTCLRINT   *(U32 *)(wdtbase + 0x000C) 
...
//interrupt combiner
#define   irqcombinerbase    0x10440000

#define   IESR0     *(U32 *)(irqcombinerbase + 0x0000)
#define   IECR0     *(U32 *)(irqcombinerbase + 0x0004)
#define   ISTR0     *(U32 *)(irqcombinerbase + 0x0008)
#define   IMSR0     *(U32 *)(irqcombinerbase + 0x000C)
#define   IESR1     *(U32 *)(irqcombinerbase + 0x0010)
#define   IECR1     *(U32 *)(irqcombinerbase + 0x0014)
#define   ISTR1     *(U32 *)(irqcombinerbase + 0x0018)
#define   IMSR1     *(U32 *)(irqcombinerbase + 0x001C)
#define   IESR2     *(U32 *)(irqcombinerbase + 0x0020)
#define   IECR2     *(U32 *)(irqcombinerbase + 0x0024)
#define   ISTR2     *(U32 *)(irqcombinerbase + 0x0028)
#define   IMSR2     *(U32 *)(irqcombinerbase + 0x002C)
#define   IESR3     *(U32 *)(irqcombinerbase + 0x0030)
#define   IECR3     *(U32 *)(irqcombinerbase + 0x0034)
#define   ISTR3     *(U32 *)(irqcombinerbase + 0x0038)
#define   IMSR3     *(U32 *)(irqcombinerbase + 0x003C)
#define   IESR4     *(U32 *)(irqcombinerbase + 0x0040)
#define   IECR4     *(U32 *)(irqcombinerbase + 0x0044)
#define   ISTR4     *(U32 *)(irqcombinerbase + 0x0048)
#define   IMSR4     *(U32 *)(irqcombinerbase + 0x004C)
#define   CIPSR0    *(U32 *)(irqcombinerbase + 0x0100)
...
#define    W1KEYCON0     *(U32 *)(lcdbase + 0x0140) 
